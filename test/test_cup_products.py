...
def test_rect22_rect22():
    ...
    res = cup_product_freepart_matrix(op, 2, 2)
    [[[a],[b]],[[c],[d]]] = res
...
def test_Z0ZZZ():
    ...
    assert abs(c03) == 1
    assert cup_product_freepart_matrix(op, 2, 2) == [[[0]]]
    # assert cup_product_freepart_matrix(op, 2, 3) == [[[0]]]
    # assert cup_product_freepart_matrix(op, 3, 3) == [[[0]]]
    # assert cup_product_freepart_matrix(op, 2, 4) == [[[0]]]
    # assert cup_product_freepart_matrix(op, 3, 4) == [[[0]]]
    # assert cup_product_freepart_matrix(op, 4, 4) == [[[0]]]
